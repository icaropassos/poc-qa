...
public class Pedidos_ProdutosPage extends BasePage {
    ...
    private final By mensagemProdutoIndisponivel = By.id("TODO");
    ...
    public String obterMensagemProdutoIndisponivel() {
        // TODO: retornar a mensagem exibida na UI
        return obterTexto(mensagemProdutoIndisponivel);
    }
}
